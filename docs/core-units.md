...
## Transports, submarines and aircraft

Moved to [`docs/core-transport.md`](core-transport.md) when this document passed the size
cap: the APC and the landing craft, the submarine cloak flag, and the flight layer.
