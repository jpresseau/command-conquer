...
function rtsSetTheatre(id) {
  ...
  _RTS_MIXBIB = null; _RTS_SHROUDSPR = null; _RTS_CLIFFLIB = undefined; _RTS_COASTLIB = {}; _RTS_ROADPAL = undefined; _RTS_WALLSET = undefined; _RTS_MIXMAKE = null; _RTS_MIXDIE = null;
...
var RTS_MIX_UNIT = {
  ...
  /* THE FLEET. Absent, so with the player's own files loaded a real Naval Yard launched
     ...
     destroyer, ss the submarine, msub the missile sub, lst the landing craft, ca the cruiser. */
  gunboat:'pt', destroyer:'dd', sub:'ss', missilesub:'msub', lst:'lst', cruiser:'ca'
};
